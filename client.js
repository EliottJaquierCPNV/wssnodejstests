...
const ws = new WebSocket('wss://wss-nodejs.vercel.app/');
...
//100 * 345ms (2,9 HZ) = 290 requests / second (100 clients send 2.9 msg/s and server will broadcast it to all clients)
